        ...
        <div className="grid grid-cols-[2fr_1fr_1.5fr_1fr] max-lg:grid-cols-2 max-sm:grid-cols-1 gap-8 md:gap-12 mb-12 md:mb-16">
          <div>
            ...
            <p className="text-muted text-[0.9rem] leading-relaxed mb-6 max-w-62.5">
              Creating moments of daily indulgence through the art of artistic
              baking.
            </p>
          ...
          <div className="flex flex-col">
            <h4 className="font-sans text-base font-bold text-secondary mb-6">
              Explore
            </h4>
            <ul className="flex flex-col gap-4">
              <li>
                <Link
                  href="#"
                  className="text-muted text-[0.9rem] transition-colors duration-200 hover:text-secondary">
                  Cake Gallery
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex justify-between text-[0.9rem] text-muted font-medium">
                <span>Sunday:</span>
                <span>Open 24 hours</span>
              </li>
              <li className="flex justify-between text-red-800 text-[0.9rem]">Business opens by 9:30am every Thursday.</li>
            </ul>
          </div>
        </div>
