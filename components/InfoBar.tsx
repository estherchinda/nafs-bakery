...
export const InfoBar = () => {
  return (
    <div className="bg-[#F8F6C9] py-4 px-4 md:px-16 border-b border-border min-h-18 grid grid-cols-2 md:flex md:flex-wrap items-center justify-between gap-4 md:gap-4">
        <div className="flex items-start md:items-center gap-2 text-[0.8rem] md:text-[0.9rem] text-secondary">
